...
class EventResourceIT {
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event().title(DEFAULT_TITLE).start(DEFAULT_START).end(DEFAULT_END);
        return event;
    }
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event().title(UPDATED_TITLE).start(UPDATED_START).end(UPDATED_END);
        return event;
    }
    ...
    void putNewEvent() throws Exception {
        ...
        updatedEvent.title(UPDATED_TITLE).start(UPDATED_START).end(UPDATED_END);
    ...
    void partialUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.title(UPDATED_TITLE).end(UPDATED_END);
    ...
    void fullUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.title(UPDATED_TITLE).start(UPDATED_START).end(UPDATED_END);
