...
describe('Team e2e test', () => {
  ...
  it('should load Teams', async () => {
    ...
    expect(await teamComponentsPage.getTitle()).to.eq('Teams');
  ...
  it('should load create Team page', async () => {
    ...
    expect(await teamUpdatePage.getPageTitle()).to.eq('Create or edit a Team');
  ...
  it('should create and save Teams', async () => {
    ...
    await promise.all([
      ...
      teamUpdatePage.calendarSelectLastOption(),
      teamUpdatePage.leaderSelectLastOption(),
    ]);
  ...
  it('should delete last Team', async () => {
    ...
    expect(await teamDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Team?');
